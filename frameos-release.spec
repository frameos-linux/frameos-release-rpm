...
%define product_family FrameOS Linux
%define release_name Ground 0
...
Provides:       redhat-release system-release frameos-release
Source0:        frameos-release-6.tar.gz

%description
%{product_family} release files

%prep
%setup -q -n frameos-release-6
...
echo "cpe:/o:frameos:enterprise_linux:%{version}:%{?beta:beta}%{!?beta:GA}" | tr [A-Z] [a-z] > $RPM_BUILD_ROOT/etc/system-release-cpe
...
%changelog
* Fri Apr 15 2011 Sergio Rubio <rubiojr@frameos.org> - 6-6.0.0.39
- Added rbel6 repo

* Thu Dec 09 2010 Sergio Rubio <rubiojr@frameos.org> - 6-6.0.0.38
- FrameOS changes
